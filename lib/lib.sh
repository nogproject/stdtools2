...
# Update in 2027 to '2024 2025 2026 2027'.
timelessYears='2023 2024 2025 2026'
...
ergxRepoFullname='
    ^(
        ...
        |
        [a-zA-Z0-9-]+ _ [a-zA-Z0-9-]+ _ (201[6-9]|202[0-6]) (-(0[1-9]|1[0-2]))?
        |
...
isValidDate() {
    local ergx='^(201[3-9]|202[0-6])(-(0[1-9]|1[0-2]))?$'
    egrep -q "${ergx}" <<<"$1"
}
